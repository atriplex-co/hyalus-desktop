    ...
    <div class="flex flex-col items-center p-8 space-y-8">
      ...
      <div class="flex space-x-10 text-gray-400">
        ...
        <a
          ...
          ref="noreferrer noopener"
        >
          <LinuxIcon class="w-20 h-20 transition hover:text-gray-200" />
        </a>
      </div>
      <p class="px-4 py-2 bg-gray-900 border border-gray-800 rounded-md">
        iOS &amp; Android apps coming soon.
      </p>
      <p
        class="transition cursor-pointer text-primary-500 hover:text-primary-600"
        @click="$emit('close')"
      >
        Close
      </p>
...
export default {
  components: {
    Modal: () => import("./Modal"),
    WindowsIcon: () => import("../icons/Windows"),
    AppleIcon: () => import("../icons/Apple"),
    LinuxIcon: () => import("../icons/Linux"),
  },
};
</script>
