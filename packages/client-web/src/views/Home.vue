<template>
  <div>
    ...
    <div class="flex flex-col items-center w-full py-20">
      ...
      <p
        class="max-w-lg mt-6 text-lg text-center text-gray-400"
      >
      ...
      <div class="flex mt-8 space-x-8">
        <router-link
          class="px-6 py-4 text-white transition rounded-lg shadow-sm bg-primary-500 hover:bg-primary-600"
          to="/downloads"
          >Download for Desktop</router-link
        >
        <router-link
          class="block px-6 py-4 text-gray-400 transition rounded-lg bg-gray-800 hover:bg-gray-850"
          to="/app"
          >Open Web App</router-link
        >
      </div>
    </div>
    <div
      class="flex flex-col items-center justify-center py-24 border-t border-b bg-gray-850 border-gray-800"
    >
      <h1 class="text-4xl font-bold">A better way to communicate</h1>
      <p class="mt-4 text-lg text-gray-400">
        See why Hyalus is the safest &amp; most transparent platform to stay in
        touch on.
      </p>
      <div class="flex items-center w-full max-w-6xl mt-12 justify-evenly">
        <div class="flex flex-col max-w-xs">
          <LockIcon
            class="w-12 h-12 p-3 rounded-full bg-gray-700 text-gray-400"
          />
    ...
    <div class="flex flex-col items-center py-24 bg-gray-900">
      <h1 class="z-10 text-2xl font-bold">
        "Cryptography is the ultimate form of non-violent direct action."
      </h1>
      <p class="z-10 mt-4 text-md text-gray-400">
...
export default {
  components: {
    ...
    CodeIcon: () => import("../icons/Code"),
    PrivateIcon: () => import("../icons/Private"),
    ChipIcon: () => import("../icons/Chip"),
